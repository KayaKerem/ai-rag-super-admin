...
export function ToolConfigTab({ companyId }: ToolConfigTabProps) {
  ...
  return (
    <div className="rounded-lg border bg-card p-6">
      <div className="mb-6">
        <h2 className="text-lg font-semibold">Tool Config</h2>
        <p className="mt-1 text-sm text-muted-foreground">Şirketin kullanabileceği tool&apos;ları ve planı yönetin.</p>
      </div>
      ...
      <div className="mt-6 flex justify-end border-t pt-4">
        <Button disabled={updateToolConfig.isPending} onClick={handleSave}>
